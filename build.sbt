...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.amazonaws" % "aws-java-sdk-core" % "1.12.239" exclude ("*", "*"), // fixme after https://github.com/testcontainers/testcontainers-java/issues/4279
...
lazy val kinesis = module("kinesis", directory = "connectors")
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "software.amazon.awssdk" % "sts" % "2.17.210"
    ) ++ awsSnykOverrides
  )
  .dependsOn(core)
