...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.amazonaws" % "aws-java-sdk-core" % "1.12.286" exclude ("*", "*"), // fixme after https://github.com/testcontainers/testcontainers-java/issues/4279
