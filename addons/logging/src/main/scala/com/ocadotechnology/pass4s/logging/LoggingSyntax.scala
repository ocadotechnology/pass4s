...
object syntax {
  ...
  implicit final class LoggingSenderSyntax[F[_], P](
  ...
  implicit final class LoggingConsumerSyntax[F[_], A](
  ...
  implicit final class LoggingBrokerSyntax[F[_], P](
    private val underlying: Broker[F, P]
  ) extends AnyVal {
  ...
  implicit final class ConnectorLoggingSyntax[F[_], P](
    val self: Connector[F, P]
  ) extends AnyVal {
    ...
    def logged(
      ...
      new Connector[F, P] {
        ...
        override def consumeBatched[R >: P](
          source: Source[R]
